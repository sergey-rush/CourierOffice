...
public class UploadManager extends AsyncTask<Void, Void, Void> {
    ...
    public UploadManager(Context context, Scan scan, byte[] imageBytes) {
        _context = context;
        _scan = scan;
    ...
    private AlertDialog UploadFailed() {
